...
class TestToolRemove(unittest.TestCase):
    ...
    def test_find_nonsequential(self):
        ...
        result = find_by_timestamp(self.subs(), t("00:00:11,000"), t("00:00:12,701"))
        self.assertEqual(list(result), [self.x[0]])  # first

        result = find_by_timestamp(self.subs(), t("00:00:16,538"), t("00:00:14,203"))
        a = [
            srt.Subtitle(1, t("00:00:11,000"), t("00:00:12,701"), "A"),
            srt.Subtitle(2, t("00:00:12,701"), t("00:00:14,203"), "B"),
            srt.Subtitle(3, t("00:00:16,538"), t("00:00:17,272"), "D"),
            srt.Subtitle(4, t("00:00:16,538"), t("00:00:19,738"), "C"),
        ...
        self.assertEqual(
            list(result), sort([self.x[1], self.x[2], self.x[3], self.x[4]])  # last
        )

        result = find_by_timestamp(self.subs(), t("00:00:14,500"), self.x[0].start)
        self.assertEqual(list(result), sort([self.x[2], self.x[3], self.x[4]]))  # edges
    ...
    def test_find_sequential_adjust(self):
        ...
        self.assertEqual(list(result), a)  # first - second
